...
- **[<ins>frameworQ</ins>, Pyglet]** RL agent learns to race a car around randomly autogenerated racing tracks with deep reinforcement learning | in frameworQ (my framework ^) with a custom RL environment and a Pyglet OpenGL view.  
