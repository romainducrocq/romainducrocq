...
Right now, I am developing [wheelcc](https://github.com/romainducrocq/wheelcc), an optimizing C compiler written from scratch in C for x86-64 Linux and MacOS, and [planet](https://github.com/romainducrocq/planet) a C-like programming language based on this compiler. Before that, I worked on multiple topics related to AI, like Neuroevolution and Reinforcement Learning, mostly in Python and C++. Oh, and I use Debian stable btw.  
